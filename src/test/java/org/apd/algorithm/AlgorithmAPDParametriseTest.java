...
/**
 * Класс для параметризованного тестирования класса <b>AlgorithmAPD</b>
 * @author Ilya
 */
...
public class AlgorithmAPDParametriseTest{
    ...
    public void corConnectivityGraphCheck() {
        try {
            jpd.readGraphFromFile(fileCorrectConnectivity);
        } catch (Exception e){
    ...
    public void badConnectivityGraphCheck() throws Exception {
        try {
            jpd.readGraphFromFile(fileBadConnectivity);
        } catch (Exception e) {
            if (e instanceof FileNotFoundException)
    ...
    public void resultTest(){
        ...
        try {
            jpd.readGraphFromFile(fileGraphAPD);
        } catch (Exception e) {
            if (e instanceof FileNotFoundException)
